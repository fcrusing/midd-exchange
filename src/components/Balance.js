...
import midd from '../assets/fulllogo_nobuffer_tn.png';
...
const Balance = () => {
  ...
  return (
    <div className='component exchange__transfers'>
      ...
      {/* Deposit/Withdraw Component 1 (MIDD) */}

      <div className='exchange__transfers--form'>
        <div className='flex-between'>
          <p><small>Token</small><br /><img src={midd} alt="Token Logo" />{symbols && symbols[0]}</p>
